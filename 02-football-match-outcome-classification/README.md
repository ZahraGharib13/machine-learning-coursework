...
```python
pd.read_csv("data/student_version2.csv", low_memory=False)
```

The original notebook contains 110,938 rows and 190 columns in its saved exploratory output.

No public dataset link is included because a public source has not been confirmed.
